...
function compile_partition() {
    rm -f $2.$5.$3$4
    find conll-formatted-ontonotes-5.0/conll-formatted-ontonotes-5.0/data/$1/data/$5/annotations -name *.$4 -exec cat {} >> $2.$5.$3$4 \;
    # cat conll-formatted-ontonotes-5.0/conll-formatted-ontonotes-5.0/data/$1/data/$5/annotations/*/*/*/*.$4 >> $2.$5.$3$4
}

function compile_language() {
    compile_partition development dev v4 gold_conll $1
    compile_partition train train v4 gold_conll $1
    compile_partition test test v4 gold_conll $1
}
